...
> **Διόρθωση (this build).** Αυτή η έκδοση διορθώνει το γνωστό πρόβλημα ότι το
> `pop_60m` δεν ανέβαινε πριν ξεκινήσει η βροχή, αλλά 30–60 λεπτά αφού είχε
> ξεκινήσει. Τα αίτια, οι αλλαγές και οι μετρήσεις (πραγματικό `python3 main.py`)
> είναι στο [`FIX_NOTES.md`](FIX_NOTES.md). Οδηγίες εγκατάστασης εκεί — προσοχή:
> το `core/features.py` είναι **νέο** αρχείο, δεν αντικαθίσταται.
